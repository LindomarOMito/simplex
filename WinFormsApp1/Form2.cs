...
namespace WinFormsApp1
{
    public partial class Form2 : Form
    {
        ...
        void SimplexIterations(FlowLayoutPanel panel, List<List<double>> table, List<string> allVars, List<string> leftVars)
        {
            ...
            for (iteration = 0; !Stop(table); iteration++)
            {
                ...
                AddText(MainPanel, "- Interação " + (iteration + 1) + ":", Color.Green);
                ...
                string S = allVars[BaseVariableindex] + " Entrou nas váriaveis básicas, " + leftVars[UpToBaseVariableindex] + " Saindo das váriaveis básicas.";
            ...
            if (pivot != 0 && !Sycle)
            {
                ...
                AddText(MainPanel, "● Opções de solução encontradas:", Color.FromArgb(0, 46, 119));
 ...
 //                   }
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            AddText(MainPanel, "● O problema de programação linear fornecido:", Color.FromArgb(0, 46, 119));
            ShowTheProblem(MainPanel);
            AddText(MainPanel, "Restrições definidas:", Color.Black);
            ShowConstraints(MainPanel);
            AddText(MainPanel, "", Color.Black);
            AddText(MainPanel, "● Definição da forma padrão:", Color.FromArgb(0, 46, 119));
            ShowStandardForm(MainPanel);
            AddText(MainPanel, "", Color.Black);
            AddText(MainPanel, "● Construindo a primeira tabela:", Color.FromArgb(0, 46, 119));
            ShowFirstTab(
                MainPanel,
            ...
            AddText(MainPanel, "", Color.Black);
            AddText(MainPanel, "● Interações do Algoritiomo Simplex:", Color.FromArgb(0, 46, 119));
            SimplexIterations(
                MainPanel,
                ReturnTheNewTable(Form1.ProblemCons, Form1.ProblemDirection, Form1.RightVal),
                ReturnAllVariables(Form1.ProblemCons, Form1.ProblemDirection),
